...
void STKSetArythmeticLhs(STKArythmetic* a, STKNode* node){
  if (a->m_lhs != NULL)STKArythmeticTerm(a);
  a->m_lhs = node;
  STKArythmeticInit(a);
}

void STKSetArythmeticRhs(STKArythmetic* a, STKNode* node){
...
//--------------------------------------------------------------------
void STKSetArythmeticMode(STKArythmetic* a, STKArythmeticMode mode)
{
  if (mode != a->m_mode)
  {
    STKArythmeticTerm(a);
...
//--------------------------------------------------------------------
// STKArythmetic Set Scalar
//--------------------------------------------------------------------
void STKSetArythmeticScalar(STKArythmetic* a, StkFloat scalar)
{
  a->m_scalar = scalar;
}
